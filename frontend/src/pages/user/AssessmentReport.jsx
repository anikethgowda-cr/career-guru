...
export default function AssessmentReport() {
    ...
    const { userAssessments, selectedReport, loading, reportLoading, serverError, reportError } =
    ...
    const completedAssessments = useMemo(() => {
        return (
            userAssessments?.filter((assessment) => {
            ...
            <div className="p-6 sm:p-8 lg:p-10 max-w-7xl mx-auto space-y-8 text-left animate-pulse">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-6 border-b border-[#E2E8F0]/80 dark:border-zinc-800">
                    <div className="space-y-2">
                        <div className="w-72 h-8 bg-slate-200 dark:bg-zinc-800 rounded-xl"></div>
                        <div className="w-96 h-4 bg-slate-200/60 dark:bg-zinc-800/60 rounded-lg"></div>
                    </div>
                    <div className="w-32 h-8 bg-slate-200 dark:bg-zinc-800 rounded-full"></div>
                </div>
    ...
    return (
        <div className="p-6 sm:p-8 lg:p-10 max-w-7xl mx-auto space-y-8 text-left transition-colors duration-300">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-red-700 dark:text-red-300 mt-0.5">
                                {typeof serverError === "string" ? serverError : serverError?.message || "Server connection error."}
                            </p>
                        </div>
                    </div>
                    <button
            ...
            {/* Controls Bar: Search & Difficulty Filter Card */}
            <div className="bg-[#FFFFFF] dark:bg-zinc-900 border border-[#E2E8F0] dark:border-zinc-800 rounded-2xl p-4 sm:p-5 flex flex-col md:flex-row gap-4 items-stretch md:items-center justify-between shadow-xs">
                ...
                <div className="relative flex-1 max-w-md">
                    ...
                    <input
                        ...
                        placeholder="Search by assessment title, role, or mentor..."
            ...
            {filteredAssessments.length > 0 && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredAssessments.map((assessment) => (
                        <div
                            key={assessment._id}
                            className="bg-[#FFFFFF] dark:bg-zinc-900 border border-[#E2E8F0] dark:border-zinc-800 border-t-4 border-t-emerald-500 dark:border-t-emerald-500 rounded-2xl p-6 shadow-xs hover:shadow-md transition-all duration-200 flex flex-col justify-between"
                        >
                            <div>
                                {/* Top Badges */}
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white text-xs sm:text-sm font-semibold rounded-xl shadow-xs hover:shadow-md transition-all cursor-pointer"
                            >
            ...
            {completedAssessments.length === 0 && (
                <div className="bg-[#FFFFFF] dark:bg-zinc-900 border border-[#E2E8F0] dark:border-zinc-800 border-t-4 border-t-indigo-500 rounded-3xl p-8 sm:p-12 text-center max-w-lg mx-auto space-y-6 shadow-sm">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white text-xs sm:text-sm font-semibold shadow-xs hover:shadow-md transition-all cursor-pointer"
                    >
