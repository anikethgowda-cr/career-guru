...
export default function Suggestion() {
  ...
  return (
    <div className="bg-bg-surface border border-border-default border-t-4 border-t-sky-500 dark:border-t-sky-400 rounded-xl shadow-card hover:shadow-elevated transition-all duration-200 p-6 flex flex-col">
      <div className="flex items-center justify-between pb-4 border-b border-border-default mb-5">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-lg bg-sky-50 dark:bg-sky-950/60 text-sky-600 dark:text-sky-400 flex items-center justify-center shadow-xs">
      ...
      {serverError && (
        <p className="mb-4 p-3 text-xs rounded-lg bg-status-danger-subtle text-status-danger">
      ...
      {suggestions.length === 0 ? (
        <p className="text-xs text-text-muted my-auto text-center py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {suggestions.map((suggestion, index) => (
            <div
              key={index}
              className="p-4 rounded-lg bg-bg-muted border border-border-default flex flex-col justify-between hover:border-sky-300 dark:hover:border-sky-800 transition-all duration-150 shadow-subtle"
            >
